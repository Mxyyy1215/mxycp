...
<div class="main">
 ...
 <div class="ddleft">
 	<ul>
    	<li><a href="mydingdan.php" >My bid</a></li>
    	<li><a href="myonepric.php" class="cur">One price</a></li>
    </ul>
 </div>
 <div class="ddright"> 
        ...
        <td ><table width="100%" cellspacing="1" cellpadding="10" border="0px">
            <tr>
              <th width="121" height="36" bgcolor="#FFFFFF"><div align="center">Name of commodity</div></th>
               ...
               <th width="87" bgcolor="#FFFFFF"><div align="center">offer  price</div></th>
...
if(!isset($_SESSION['yonghu'])){
	...
	$rs2=mysqli_query($link,"select * from tb_study,tb_sale where tb_study.eaid=tb_sale.goodid  and tb_sale.type='1' limit $start,$pagesize");
