  ...
  $array = explode('.',$string);
   $ex = strrev($array[0]);
		...
		$photo=$tp;
		  ...
		  $upd="update tb_study set EAname='$EAname',typeid='$typeid',jianjie='$jianjie',brand='$brand',price='$price',introduction='$introduction',photo='$photo',recommend='$recommend' where eaid='$eaid'";
